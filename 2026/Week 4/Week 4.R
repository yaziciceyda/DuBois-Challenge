...
# https://github.com/ajstarks/dubois-data-portraits/tree/master/challenge/2026/challenge04
...
data_georgia <- georgia_shp %>%
  ...
  color_1870 = case_when(
    ...
    data1870 == "15,000 TO 20,000" ~ "#654321",
  ...
  color_1880 = case_when(
    ...
    data1880_p == "15,000 TO 20,000" ~ "#654321",
...
p_1870 <- data_georgia %>%
  ...
  scale_fill_identity() +
 # geom_sf_text(aes(label = nhgisnam), size = 3) +
  ...
  annotate("point", x = -80, y = 34.5, color = "black", size = 11,
           stroke = 1) + 
  ...
  # 15,000 TO 20,000
  annotate("point", x = -80, y = 33.7, color = "black", size = 11,
           stroke = 1) +
  ...
  annotate("text", x = -79, y = 33.7, label = "15,000 TO 20,000",
           color = "#a4917f", size = 8, family = "ps", hjust = 0) +
  # 10,000 TO 15,000
  annotate("point", x = -80, y = 32.9, color = "black", size = 11,
           stroke = 1) +
  ...
  theme(panel.background = element_rect(fill = "#e7d6c5", color = NA),
        ...
        plot.margin = margin(-3.0, 0.5, -3.0, 0.5, "cm"))
...
p_1880 <- data_georgia %>%
  ...
  # Legend
  # 5,000 TO 10,000
  annotate("point", x = -93, y = 34, color = "black", size = 11,
           stroke = 1) + 
  ...
  annotate("text", x = -92, y = 34, label = "5,000 TO 10,000",
           color = "#a4917f", size = 8, family = "ps", hjust = 0) +
  # 2,500 TO 5,000
  annotate("point", x = -93, y = 33.3, color = "black", size = 11,
           stroke = 1) +
  ...
  annotate("text", x = -92, y = 33.3, label = "2,500 TO 5,000",
           color = "#a4917f", size = 8, family = "ps", hjust = 0) +
  # 1,000 TO 2,500
  annotate("point", x = -93, y = 32.6, color = "black", size = 11,
           stroke = 1) +
  ...
  annotate("text", x = -92, y = 32.6, label = "1,000 TO 2,500",
           color = "#a4917f", size = 8, family = "ps", hjust = 0) +
  # UNDER 1,000
  annotate("point", x = -93, y = 31.9, color = "black", size = 11,
           stroke = 1) +
  ...
  theme(panel.background = element_rect(fill = "#e7d6c5", color = NA),
        ...
        axis.ticks = element_blank(),
        axis.text = element_blank(),
        plot.margin = margin(-3.0, 0.1, -3.0, 0.1, "cm"))
...
final_plot <- p_1870 + p_1880 + plot_layout(nrow = 2, 
   ...
   plot_annotation(
    ...
    caption = "#DuboisChallenge26| Week 4 | Prepared by C. YAZICI") &
...
ggsave("Week4.png", final_plot, width = 16, height = 20, dpi = 72)
